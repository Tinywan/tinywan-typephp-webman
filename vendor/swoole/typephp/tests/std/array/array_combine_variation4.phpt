...
--SKIPIF--
<?php die("skip AOT float-to-string key precision differs from PHP"); ?>
--FILE--
<?php
// get a class
class classA
...
function main()
{
    ...
    */
    ...
    $arrays = array(
        ...
        /*11*/
        array('hello' => 1, "fruit" => 2.2, $fp => 'resource', 133 => "int", @$unset_var => "unset", $heredoc => "heredoc"),
    );
    // array to be passsed to $arr2 argument
    $arr2 = array(0 => 0, 2 => "float", 4 => "f3", 33333333 => "f4", "\tHello" => 111, 2.2, 'color', "Hello world" => "string", "pen\n" => 33, 133 => "int");
