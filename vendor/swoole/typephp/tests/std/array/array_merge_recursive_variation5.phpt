...
--SKIPIF--
<?php die("skip AOT array_merge numeric key reindexing differs from PHP"); ?>
--FILE--
<?php
// get a class
class classA
...
function main()
{
    ...
    */
    ...
    $arrays = array(
        ...
        /*3*/
        array("f1" => 2.3333, "f2" => 2.3333, "f3" => array(1.1, 2.22)),
        ...
        /*8*/
        array(11 => new classA(), "string" => @$unset_var, "resource" => $fp, new classA(), $fp),
    );
