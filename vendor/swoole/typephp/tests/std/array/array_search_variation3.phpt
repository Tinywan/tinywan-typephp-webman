...
--SKIPIF--
<?php die("skip AOT array search differs from PHP for resources/objects"); ?>
--FILE--
<?php
...
function main()
{
    ...
    $sub_array = array("one", array(1, 2 => "two", "three" => 3), 4 => "four", "five" => 5, array('', 'i'));
    ...
    $array_search_obj = new array_search_check();
    //creating new object
