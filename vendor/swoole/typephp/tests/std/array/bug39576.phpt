...
--SKIPIF--
<?php die("skip AOT array_walk userdata reference differs from PHP"); ?>
--FILE--
<?php
class Test
{
...
function main()
{
    ...
    array_walk(get_object_vars($test), 'test', $test->_columns);
    var_dump($test);
    array_intersect_key(get_object_vars($test), $test->_primary);
    echo "Done\n";
}
?>
--EXPECTF--
