...
--SKIPIF--
<?php die("skip AOT does not support parameter count mismatch in callbacks"); ?>
--FILE--
<?php
/*
...
function callback_two_parameter($value, $key, $arg)
{
...
function callback_one_parameter($value, $key, $arg)
{
   // dump the arguments to check that they are passed
   // with proper type
   var_dump($value); // value
...
function callback_no_parameter($value, $key, $arg)
{
