...
function main()
{
    ...
    $inputs = array(
        // int data
        /*1*/
        'int' => array(0, 1, 12345, -2345),
        // float data
        /*2*/
        'float' => array(10.5, -10.5, 123456789000.0, 1.23456789E-9, 0.5),
        // null data
        /*3*/
        ...
        // string data
        /*6*/
        'string' => array("string", 'string', $heredoc),
        // binary data
        /*7*/
        'binary' => array("binary", (string) "binary"),
        // object data
        /*8*/
        'object' => array(new classA()),
        // undefined data
        /*9*/
        'undefined' => array(@$undefined_var),
        // unset data
        /*10*/
        'unset' => array(@$unset_var),
    );
